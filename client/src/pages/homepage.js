...
function HomePage() {
  return (
    <div>
      ...
      <Link to="/login" className="sign-up"><button>Sign up</button></Link>
      </div>
      <section className="upload-container">
        ...
        <div className="sharing-container">
          ...
          <div className="direct-email">
            <a href="/email-page" className="email-link">
              or send via email
            </a>
          </div>
      ...
      <a href="https://github.com/ShivamJoker/inshare" className="github-corner" aria-label="View source on GitHub">
        <svg
          ...
          height="80"
          viewBox="0 0 250 250"
          style={{ fill: '#131315c9', color: '#fff', position: 'absolute', top: 0, border: 0, right: 0 }}
          aria-hidden="true"
        >
